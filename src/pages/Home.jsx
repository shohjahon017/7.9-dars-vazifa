  ...
  return (
    <div className="text-white">
      ...
      <section className="max-w-6xl mx-auto px-6 py-24">
        <h2 className="text-4xl font-bold text-center mb-16">
          Ota-onalar <span className="text-blue-400">fikri</span>
        </h2>

        <div className="grid md:grid-cols-3 gap-8">
          {[
            {
              text: "Farzandim matematika fanidan qiynalardi. Universe’da o‘qishni boshlagach, baholari va ishonchi sezilarli oshdi.",
              name: "Dilshod aka",
              role: "9-sinf o‘quvchisi otasi",
            },
            {
              text: "O‘g‘lim IELTS kursida o‘qiyapti. O‘qituvchilar juda tushunarli va talabchan. Natijalar bizni juda xursand qildi.",
              name: "Malika opa",
              role: "IELTS o‘quvchisi onasi",
            },
            {
              text: "Qizim arab tilini noldan boshladi. Hozir esa erkin o‘qib, gapira boshladi. Juda minnatdorman.",
              name: "Zuhra opa",
              role: "Arab tili o‘quvchisi onasi",
            },
          ].map((item, i) => (
            <motion.div
              key={i}
